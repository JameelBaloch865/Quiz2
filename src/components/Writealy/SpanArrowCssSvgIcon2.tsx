...
const SpanArrowCssSvgIcon2 = (props: SVGProps<SVGSVGElement>) => (
  <svg preserveAspectRatio='none' viewBox='0 0 20 20' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
    <g clipPath='url(#clip0_24_1493)'>
      <path
...
const Memo = memo(SpanArrowCssSvgIcon2);
export { Memo as SpanArrowCssSvgIcon2 };
